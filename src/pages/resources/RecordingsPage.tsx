  ...
  careerChats: [
    {
      ...
      speaker: "Dr. Maria Rodriguez, MBA, FACHE",
      date: "2024-01-17",
      duration: "1:12:45",
      views: 2847,
      description: "Comprehensive overview of healthcare administration opportunities, including hospital management, health information systems, and healthcare consulting.",
    ...
    },
    {
      ...
      speaker: "Robert Kim, CFP, CFA",
      date: "2024-01-10",
      duration: "58:33",
      views: 3621,
      description: "Deep dive into financial planning careers, from personal financial planning to corporate finance and investment management.",
    ...
    {
      id: 3,
      title: "Modern Teaching and Educational Leadership",
      speaker: "Dr. Jennifer Taylor, Ed.D.",
      date: "2024-01-03",
      duration: "49:18",
      views: 1943,
      description: "Exploring careers in education, from classroom teaching to educational administration and curriculum development.",
    ...
    {
      id: 7,
      title: "Technology and Software Development Paths",
      speaker: "Michael Chen, Senior Software Engineer",
      date: "2023-12-20",
      duration: "1:03:22",
      views: 4156,
      description: "Career opportunities in software development, cybersecurity, data science, and emerging technologies.",
      topics: ["Technology", "Programming", "Innovation"],
    ...
    },
    {
      ...
      speaker: "Sarah Mitchell, MBA",
      date: "2023-12-13",
      duration: "55:47",
      views: 2734,
      description: "Starting and growing your own business, including funding options, business planning, and scaling strategies.",
  ...
  devotionals: [
    {
      ...
      duration: "32:18",
      views: 12847,
      description: "Understanding the eternal significance of learning and education in our lives and how knowledge can bless ourselves and others.",
    ...
    },
    {
      ...
      duration: "28:42",
      views: 9653,
      description: "Practical and spiritual insights for overcoming difficulties in education, maintaining faith during struggles, and finding strength in the Lord.",
    ...
    },
    {
      ...
      duration: "26:33",
      views: 8291,
      description: "How faith enhances our ability to learn and understand truth, integrating spiritual and secular learning in our educational journey.",
    ...
    {
      id: 9,
      title: "Balancing Work, Family, and Education",
      speaker: "Elder Jeffrey R. Holland",
      date: "2023-12-11",
      duration: "35:15",
      views: 11429,
      description: "Guidance on managing multiple responsibilities while pursuing education, maintaining family relationships, and spiritual growth.",
      topics: ["Balance", "Family", "Priorities"],
